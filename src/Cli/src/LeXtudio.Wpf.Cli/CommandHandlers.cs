...
namespace LeXtudio.Wpf.Cli
{
    public static class CommandHandlers
    {
        ...
        public static int RunDevFlow(Queue<string> tokens, OutputOptions options)
        {
            if (tokens.Count == 0)
            {
                return WriteResult("devflow", "Usage: dotnet wpflex devflow <status|screenshot|tap|webview|extensions|inspector|broker|network|ui|alert> [options]", options);
            }
            ...
            return subcommand switch
            {
                ...
                "help" => WriteResult("devflow", "Usage: dotnet wpflex devflow <status|screenshot|tap|webview|extensions|inspector|broker|network|ui|alert> [options]", options),
                "--help" => WriteResult("devflow", "Usage: dotnet wpflex devflow <status|screenshot|tap|webview|extensions|inspector|broker|network|ui|alert> [options]", options),
                "-h" => WriteResult("devflow", "Usage: dotnet wpflex devflow <status|screenshot|tap|webview|extensions|inspector|broker|network|ui|alert> [options]", options),
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet wpflex devflow extensions <list|describe|call> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet wpflex devflow extensions <list|describe|call> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet wpflex devflow broker <start|stop|status|list> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet wpflex devflow broker <start|stop|status|list> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet wpflex devflow network <list|detail|clear> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet wpflex devflow network <list|detail|clear> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet wpflex devflow ui <query|hit-test|assert> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet wpflex devflow ui <query|hit-test|assert> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet wpflex devflow alert <detect|dismiss> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet wpflex devflow alert <detect|dismiss> [options]", options)
            };
        }
