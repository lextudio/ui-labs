...
namespace LeXtudio.Wpf.Cli
{
    public static class Program
    {
        ...
        private static int RunCommandsSchema()
        {
            var commands = new[]
            {
                new { name = "doctor", description = "Validate the WPF development environment" },
                new { name = "version", description = "Display CLI and environment version information" },
                new { name = "new", description = "Scaffold a new WPF app or library" },
                new { name = "build", description = "Build a WPF project with WPF-aware defaults" },
                new { name = "run", description = "Run a WPF application" },
                new { name = "publish", description = "Publish a WPF application for deployment" },
                new { name = "package", description = "Package WPF output artifacts" },
                new { name = "diagnostics", description = "Run WPF-specific diagnostics and validation" },
                new { name = "env", description = "Inspect installed SDKs and tooling" },
                new { name = "devflow", description = "Query a running WPF DevFlow agent and inspect runtime state" },
