...
namespace LeXtudio.MewUI.Cli
{
    public static class Program
    {
        ...
        private static int RunCommandsSchema()
        {
            var commands = new[]
            {
                new { name = "doctor", description = "Validate the MewUI development environment" },
                new { name = "version", description = "Display CLI and environment version information" },
                new { name = "new", description = "Scaffold a new MewUI app" },
                new { name = "build", description = "Build a MewUI project" },
                new { name = "run", description = "Run a MewUI application" },
                new { name = "publish", description = "Publish a MewUI application" },
                new { name = "package", description = "Package MewUI output artifacts" },
                new { name = "diagnostics", description = "Run MewUI diagnostics and validation" },
                new { name = "env", description = "Inspect installed SDKs and tooling" },
                new { name = "devflow", description = "Query a running MewUI DevFlow agent and inspect runtime state" },
