...
namespace LeXtudio.MewUI.Cli
{
    public static class CommandHandlers
    {
        ...
        public static int RunDevFlow(Queue<string> tokens, OutputOptions options)
        {
            if (tokens.Count == 0)
            {
                return WriteResult("devflow", "Usage: dotnet mewlex devflow <status|screenshot|tap|extensions|inspector|broker|network|ui|alert> [options]", options);
            }
            ...
            return subcommand switch
            {
                ...
                "help" => WriteResult("devflow", "Usage: dotnet mewlex devflow <status|screenshot|tap|extensions|inspector|broker|network|ui|alert> [options]", options),
                "--help" => WriteResult("devflow", "Usage: dotnet mewlex devflow <status|screenshot|tap|extensions|inspector|broker|network|ui|alert> [options]", options),
                "-h" => WriteResult("devflow", "Usage: dotnet mewlex devflow <status|screenshot|tap|extensions|inspector|broker|network|ui|alert> [options]", options),
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet mewlex devflow extensions <list|describe|call> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet mewlex devflow extensions <list|describe|call> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet mewlex devflow broker <start|stop|status|list> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet mewlex devflow broker <start|stop|status|list> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet mewlex devflow network <list|detail|clear> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet mewlex devflow network <list|detail|clear> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet mewlex devflow ui <query|hit-test|assert> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet mewlex devflow ui <query|hit-test|assert> [options]", options)
            };
        }
        ...
        {
            if (tokens.Count == 0)
                return WriteResult("devflow", "Usage: dotnet mewlex devflow alert <detect|dismiss> [options]", options);
            ...
            return sub switch
            {
                ...
                _ => WriteResult("devflow", "Usage: dotnet mewlex devflow alert <detect|dismiss> [options]", options)
            };
        }
