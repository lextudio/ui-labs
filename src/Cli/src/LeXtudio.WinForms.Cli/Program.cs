...
namespace LeXtudio.WinForms.Cli
{
    public static class Program
    {
        ...
        private static int RunCommandsSchema()
        {
            var commands = new[]
            {
                new { name = "doctor", description = "Validate the WinForms development environment" },
                new { name = "version", description = "Display CLI and environment version information" },
                new { name = "new", description = "Scaffold a new WinForms app or library" },
                new { name = "build", description = "Build a WinForms project with WinForms-aware defaults" },
                new { name = "run", description = "Run a WinForms application" },
                new { name = "publish", description = "Publish a WinForms application for deployment" },
                new { name = "package", description = "Package WinForms output artifacts" },
                new { name = "diagnostics", description = "Run WinForms-specific diagnostics and validation" },
                new { name = "env", description = "Inspect installed SDKs and tooling" },
                new { name = "devflow", description = "Query a running WinForms DevFlow agent and inspect runtime state" },
