...
namespace LeXtudio.Jalium.Cli
{
    public static class Program
    {
        ...
        private static int RunCommandsSchema()
        {
            var commands = new[]
            {
                new { name = "doctor", description = "Validate the Jalium development environment" },
                new { name = "version", description = "Display CLI and environment version information" },
                new { name = "new", description = "Scaffold a new Jalium app" },
                new { name = "build", description = "Build a Jalium project" },
                new { name = "run", description = "Run a Jalium application" },
                new { name = "publish", description = "Publish a Jalium application" },
                new { name = "package", description = "Package Jalium output artifacts" },
                new { name = "diagnostics", description = "Run Jalium diagnostics and validation" },
                new { name = "env", description = "Inspect installed SDKs and tooling" },
                new { name = "devflow", description = "Query a running Jalium DevFlow agent and inspect runtime state" },
